...
type EditableItemViewType = Parameters<typeof EditableItemForTag>[0];
import { TagType } from '../types';

export default function EditableItemForTag(props: {
  originalValue: TagType;
  ...
  return (
    <>
      ...
      {props.onErase && !editableItem.isEditing && (
        <IconButton
          onClick={() => {
            props.onErase && props.onErase(props.originalValue.tagId);
          }}
        >
          <Delete />
        </IconButton>
